...
#     print("Общие элементы в обоих множествах:", common_elements)

# n = int(input("Введите количество элементов первого множества: "))
# m = int(input("Введите количество элементов второго множества: "))

# common_elements_set(n, m)
...
# def max_collected_berries(N, bushes):
#     if N == 3:
#         return sum(bushes)
...
#     for i in range(N):
#         current_collected = bushes[i] + bushes[(i + 1) % N] + bushes[(i + 2) % N]
...
# bushes = list(map(int, input("Введите урожайность каждого куста через пробел: ").split()))

# result = max_collected_berries(N, bushes)
